...
static const variant_info_t apollo_global_info = {
    ...
    .marketname = "Mi 10T",
    .model = "M2007J3SY",
    .build_fingerprint = "Xiaomi/apollo_eea/apollo:12/RKQ1.211001.001/V13.0.2.0.SJDEUXM:user/release-keys",
...
static const variant_info_t apollopro_info = {
    ...
    .model = "M2007J3SG",
    .build_fingerprint = "Xiaomi/apollopro_eea/apollo:12/RKQ1.211001.001/V13.0.2.0.SJDEUXM:user/release-keys",
